...
export const GLOBAL_STYLE_CONFIG: Record<GlobalStyleId, GlobalStyleConfig> = {
  formal: {
    ...
    temperature: 0.2,
    accentClass: 'border-2 border-[#D97757] shadow-[0_0_0_3px_rgba(217,119,87,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#D97757] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: 'A',
  },
  casual: {
    id: 'casual',
    ...
    temperature: 0.32,
    accentClass: 'border-2 border-[#788C5D] shadow-[0_0_0_3px_rgba(120,140,93,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#788C5D] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: 'Hi',
  },
  very_casual: {
    ...
    model: 'llama-3.1-8b-instant',
    temperature: 0.55,
    accentClass: 'border-2 border-[#E29E4B] shadow-[0_0_0_3px_rgba(226,158,75,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#E29E4B] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: 'txt',
  },
  concise: {
    ...
    model: 'llama-3.1-8b-instant',
    temperature: 0.15,
    accentClass: 'border-2 border-[#6A9BCC] shadow-[0_0_0_3px_rgba(106,155,204,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#6A9BCC] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: 'TL;DR',
  },
  code: {
    ...
    model: 'llama-3.3-70b-versatile',
    temperature: 0.12,
    accentClass: 'border-2 border-[#88867E] shadow-[0_0_0_3px_rgba(136,134,126,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#88867E] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: '</>',
  },
  excited: {
    ...
    model: 'llama-3.1-8b-instant',
    temperature: 0.45,
    accentClass: 'border-2 border-[#A28BB5] shadow-[0_0_0_3px_rgba(162,139,181,0.24)]',
    selectedSurfaceClass: 'bg-[#EDEAE0]',
    selectedPillClass: 'bg-[#A28BB5] text-white',
    bubbleClass: 'bg-[#EDEAE0] text-[#141413]',
    badgeLabel: '!',
  },
};
